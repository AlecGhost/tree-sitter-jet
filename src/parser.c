...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [18] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(13),
  ...
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scriptlet, 3),
  [43] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scriptlet, 3),
  ...
  [51] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_directive_repeat1, 2), SHIFT_REPEAT(16),
  ...
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute, 3),
  ...
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_java, 1),
...
extern const TSLanguage *tree_sitter_jet(void) {
